...
interface PayoutCardProps extends WithdrawalMethodIF {
  callback: (paymentMethod: WithdrawType) => void
}
...
export interface Props {
  paymentSelector: (paymentMethod: WithdrawType) => void
  open: boolean
  setOpen: (open: boolean) => void
}

export default function WithdrawalMethodDlg({
  open,
  setOpen,
  paymentSelector,
}: Props) {
    ...
    >
      ...
      >
        ...
        >
          ...
          {withdrawalMethods.map((item, idx) => {
            return (
              <PayoutCard
                key={idx}
                label={item.label}
